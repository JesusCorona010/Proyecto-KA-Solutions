...
function initializeNavigation() {
    document.querySelectorAll('.nav-menu li, .cta-button, .section-button').forEach(item => {
        item.addEventListener('click', function() {
            ...
            if (this.classList.contains('cta-button') || this.classList.contains('section-button')) {
